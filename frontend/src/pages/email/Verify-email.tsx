...
const VerifyEmail: React.FC = () => {
    ...
    return (
        <main className="w-full min-h-screen relative">
            <Background/>
            <div className="relative z-50 flex items-center justify-end w-full lg:w-[90%] min-h-screen py-6 md:py-12 px-2 sm:px-4">
                    ...
                    <div className="w-full h-auto p-4 rounded-lg bg-white/5 backdrop-blur-sm sm:p-6">
                        ...
                        <div className="text-center mt-3">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="mt-4">
                                    <Link to={routes.login()} className="text-cosmic hover:underline text-sm">
                                        Back to Login
                                    </Link>
                                </div>
                            </div>
