            ...
            <div className="relative h-full z-50 w-[90%] mx-auto flex items-center justify-end">
                <div className="flex flex-col gap-2 w-[400px]">
                    ...
                    <div className="w-full flex items-center justify-center">
                        <div className="text-white">Remember your password? <Link to={routes.login()} className="text-sapphire font-bold hover:underline hover:text-candy" >Back to login </Link></div> 
                    </div>
                </div>
            </div>
        </main>
