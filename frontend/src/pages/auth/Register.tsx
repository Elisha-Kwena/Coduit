          ...
          <div className="w-full lg:w-[400px] h-full py-2">
            <form onSubmit={handleSubmit} className="w-full flex flex-col items-center justify-center gap-4 p-3 lg:p-0">
              ...
              <div className="flex items-center justify-center">
                <p className="text-black font-bold font-fira-code text-sm text-center">By continuing you agree to the <Link to="" className='hover:text-candy hover:underline text-sapphire font-bold'>Terms of Sevice</Link> and <Link to="" className='hover:text-candy hover:underline text-sapphire font-bold' >Privacy Policy</Link> of Coduit</p>
              </div>


              {/* Login Link */}
              <p className="text-white text-sm font-fira-code">
                Already have an account? <Link to={routes.login()} className="text-sapphire hover:text-candy font-bold hover:underline">Login</Link>
              </p>
            </form>
          </div>
        </div>
