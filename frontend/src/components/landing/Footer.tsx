                    ...
                    <div className="flex flex-col items-start gap-1">
                        ...
                        <div className="flex items-center justify-center gap-2 mt-4">
                            <a href="" className="flex items-center justify-start gap-1 p-2 px-3 rounded-md bg-white">
                                <img src={apple} alt="" className="w-10 h-10 object-contain" />
                                <div className="flex flex-col gap-0 items-start justify-center">
                                    <h2 className="text-black  text-sm lg:text-md">Download on the</h2>
                                    <h1 className=" font-extrabold text-2xl -mt-2">App Store</h1>
                                </div>
                            </a>
                            <a href="" className="flex items-center justify-start gap-1 p-2 px-3 rounded-md bg-white">
                                <img src={playstore} alt="" className="w-10 h-10 object-contain" />
                                <div className="flex flex-col gap-0 items-start justify-center">
                                    <h2 className="text-black">GET IT ON</h2>
                                    <h1 className=" font-extrabold text-2xl -mt-2">Google Play</h1>
                                </div>
                            </a>
                        </div>
